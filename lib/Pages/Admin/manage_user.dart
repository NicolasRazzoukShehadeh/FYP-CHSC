                    ...
                    (BuildContext context, int index) {
                      ...
                      UserClassModel userClassModel =
                        ...
                        if (userClassModel.locked) {
                          ...
                          // If the user is currently locked, unlock the account, and set end date to after 1 months
                          ...
                          //If the user is currently unlocked, lock the account, and set expirey date to null
                          await FirebaseFirestore.instance
                              .collection('users')
                              .doc(filteredUsers[index].id)
                              .update({
